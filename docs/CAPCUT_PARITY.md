...
| E21 | Local automatic clipping | Source audio bursts, frame-change sampling, optional game HUD OCR, encounter rules, reviewed candidates, batch MP4/project export | Real-game precision/recall benchmarks, multi-hour 4K performance, game-change boundaries, broader HUD/language coverage |
