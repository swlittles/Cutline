...
- Every short uses 30% facecam, a 2% black strip with locally configured branding and an optional Kick mark, and 68% gameplay. Branding remains visible through effects, fades, overlays and captions.
...
- Creator branding and player aliases have no personal defaults. Branding is saved only on this Mac; short export requires it.
